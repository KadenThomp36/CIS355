...
// put the content of the file into a variable, $content
    ...
    function list_records() {
                        ...
                        <table class='table table-striped table-bordered'>
                            <thead>
                                <tr>
                                    ...
                                    <th>Email</th>
                                    <th>Mobile</th>
                                    <th>BLOB (Stored in Database)</th>
                                    <th>Simple File Upload (Stored in sub-directory)</th>
                                    <th>File Path on Sever</th> 	 
                                    <th>Description</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
        ...
        foreach ($pdo->query($sql) as $row) {
            ...
            echo "<td><a href=uploads/" . $row["id"] . "/" . $row['fileName'] .">" . $row["absolutepath"] . "</a></td>";
